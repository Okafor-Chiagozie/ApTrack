    ...
    <div class="mainDiv">
        ...
        <section class="section2">
            ...
            <div class="myFormSection">
                ...
                <form action="validateUser.php" method="post" id="user" class="myForm">
                    <section class="formItem">
                        <label for="userEmail">Email</label>
                        <input type="email" name="userEmail" required placeholder="Your Email" value="<?php if(isset($_SESSION["userRemember"])){echo $_SESSION["userEmail"];} ?>">
                    </section>
                    ...
                    <section class="duoFormItem">
                        ...
                        <span>
                            ...
                            <a href="email_verification.php">Forgot Password?</a>
                        </span>
                    </section>
                ...
                <form action="validateAdmin.php" method="post" id="admin" class="myForm">
                    <section class="formItem">
                        <label for="adminEmail">Email</label>
                        <input type="email" name="adminEmail" required placeholder="Your Email" value="<?php if(isset($_SESSION["adminRemember"])){echo $_SESSION["adminEmail"];} ?>">
                    </section>
