         ...
         <section class="section2">
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" class="myForm">
               <section class="formHeading">
                  ...
                  <span>Already have an account? <a href="sign_in.php">Login</a></span>
               </section>

               <section class="formItem">
                  <label for="username">Username</label>
                  <input type="text" name="username" required placeholder="Firstname Surname" maxlength="40">
               </section>
               ...
               <section class="duoFormItem">
                  ...
                  <?php if (isset($_SESSION['differentPassword']) && ($_SESSION["differentPassword"] == "Yes")) {
